...
namespace v2im {
    namespace jni {
        ...
        jobject ConversationOperationResultJni::Convert2JObject(const V2TIMConversationOperationResult &operationResult) {
            ...
            jstring conversationID_jStr = StringJni::Cstring2Jstring(env, operationResult.conversationID.CString());
            ...
            env->SetIntField(operationResultObj, j_field_array_[FieldIDResultCode], (int) operationResult.resultCode);
