...
public class GroupInfo extends ChatInfo {
    ...
    private List<V2TIMGroupMemberInfo> memberDetails = new ArrayList<>();
     ...
     * @return
     */
    public List<V2TIMGroupMemberInfo> getMemberDetails() {
     ...
     * @param memberDetails
     */
    public void setMemberDetails(List<V2TIMGroupMemberInfo> memberDetails) {
