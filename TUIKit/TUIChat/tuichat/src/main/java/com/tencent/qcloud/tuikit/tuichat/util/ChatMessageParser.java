...
//                }
                Field onlineOnlyField = v2TIMMessage.getClass().getDeclaredField("isOnlineMsg");
                onlineOnlyField.setAccessible(true);
                isOnlineOnly = onlineOnlyField.getBoolean(v2TIMMessage);
            } catch (Exception e) {
                isOnlineOnly = false;
            }
